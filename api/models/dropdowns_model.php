<?php
	class DropdownsModel extends Database{
		...
		public function getDropDowns($val,$id=""){
			...
			$sql = "SELECT " . DROPDOWNSMST . ".*,(CASE WHEN " . DROPDOWNSMST . ".`status` = 1 THEN 'active' ELSE 'inactive' END) AS statusname FROM " . DROPDOWNSMST . $where . " ORDER BY " . DROPDOWNSMST . ".`ddid`," . DROPDOWNSMST . ".`dddescription`";
		...
		public function getGenders($id=""){
			$result = "";
			$result = $this->getDropDowns('gender',$id);
			return $result;
		}
