    ...
    <div>
      ...
      <div class="login_wrapper">
        ...
        <div class="animate form login_form" id="divLogin">
          <section class="login_content"><span id="divLogin">
            ...
            <span id="divForgotPW" style="display: none;"><form method="Post">
              <div class="row">
                <input type="text" class="form-control" placeholder="Username (abaini: i.e. pmhe)" required="" id="txtUsername" name="txtUsername" />
              </div>
              <div class="row">
                <input type="button" id="btnSubmit" class="btn btn-danger" name="btnSubmit" value="Submit" />
              </div>
              <div class="row">
