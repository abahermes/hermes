<div id="corporate" class="x_content">
        ...
        <div class="row">
            <div class="col-lg-6 col-sm-6 col-xs-12">
                <div class="row">
                    <div class="x_panel">
                        <fieldset>
                            <legend>Contact Details <!-- <a href="#" title="View Client or Prospect Full Details"> <i class="fa fa-eye blue"></i></a> --> <span class="pull-right"> <a href="#" title="Edit Client or Prospect"> <i class="fa fa-pencil blue"></i></a></span></legend>
                            <div class="col-sm-12">
                    ...
                    <div class="x_panel">
                        <fieldset>
                            ...
                            <div style="height: 380px; overflow-y: scroll;">
                                <ul class="to_do">
                                    <li>
                                        <p>Wed 19 Jun 2019<br />
                                        m - 10:00 - Schedule meeting with new client</p>
                                    </li>
                                    <li>
                                        <p>
