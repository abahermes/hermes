$(function() {
  ...
  $("#btnStep2").on("click", function(){
    ...
    if( $("#txtini").val() == "" ){
      alert("Initial is required! Please enter prospect initials.");
      $("#txtini").focus();
      return false;
    }
    ...
    $("#btnStep1,#btnStep3,#secondstep").show();
    $("#btnStep1").val("Previous");
    $("#btnStep3").val("Next");
    $("#btnStep2,#btnStep4,#btnSaveCtcDtls,#firststep,#thirdstep").hide();
  });
  ...
  $("#btnStep3").on("click", function(){
    ...
    $("#btnStep1,#btnStep3,#secondstep,#fourthstep,#btnSaveCtcDtls,#btnNewGalInfo").hide();
    $("#btnStep2,#btnStep4,#thirdstep").show();
    $("#btnStep2").val("Previous");
    $("#btnStep4").val("Next");
  });
  ...
  $("#btnStep4").on("click", function(){
    ...
    $("#btnStep2,#btnStep4,#thirdstep,#galinfo").hide();
    $("#btnStep3,#btnSaveCtcDtls,#btnNewGalInfo,#fourthstep").show();
    $("#btnStep3").val("Previous");
  });

  $("#btnNewGalInfo").on("click", function(){
    $("#btnStep3,#btnNewGalInfo,#fourthstep").hide();
    $("#btnStep4,#galinfo").show();
    $("#btnStep4").val("Previous");
  });
  ...
  $("#btnCancelCtcDtls").on("click", function(){
    clearCltProstFields();
    $("#btnStep1,#btnStep3,#btnStep4,#btnSaveCtcDtls,#secondstep,#thirdstep,#fourthstep,#divFumExist,#btnNewGalInfoItem,#galinfo").hide();
  ...
  $("#btnSaveCtcDtls").on("click", function(){
    $.blockUI({ 
  ...
  html += '<table class="table table-striped jambo_table table-condensed table-hover table-bordered">';
    ...
    html += '<tbody>';
      ...
      for(var i=0; i<data.length;i++){
        ...
        html += '<tr onClick="return createPipeline('+ param +');" style="cursor: pointer;">';
  ...
  html += '<table class="table table-striped jambo_table table-condensed table-hover table-bordered">';
    ...
    html += '<tbody>';
      ...
      for(var i=0; i<data.length;i++){
        ...
        param = data[i]['id'] +'::';
        param += data[i]['title'] +'::'; // salutation
        param += data[i]['firstname'] +'::'; // first name
        param += data[i]['lastname'] +'::'; // last name
        param += data[i]['middlename'] +'::'; // middle name
        param += data[i]['chinesename'] +'::'; // suffix or CN name
        param += data[i]['companyname'] +'::'; // company name
        param += address +'::';
        param += data[i]['businessphoneno'] +'::'; // business phone no
        param += data[i]['mobilephoneno'] +'::'; // mobile phone no
...
function saveLeads(data){
  ...
  //   // param = "'"+ param +"'";
  //   row = [];
  //   row = { "etag":data[i]['@odata.etag'], "birthday":data[i]['birthday'], "city":data[i]['businessAddress']['city'], "countryorregion":data[i]['businessAddress']['countryOrRegion'], 
  //           "state":data[i]['businessAddress']['state'], "street":data[i]['businessAddress']['street'], "website":data[i]['businessHomePage'], 
  //           "businessphoneno":data[i]['businessPhones'][0], "companyname":data[i]['companyName'], "displayname":data[i]['displayName'], 
  //           "emailaddress":data[i]['emailAddresses'][0]['address'], "suffix":data[i]['generation'], "firstname":data[i]['givenName'], "id":data[i]['id'], 
  //           "initials":data[i]['initials'], "jobtitle":data[i]['jobTitle'], "middlename":data[i]['middleName'], "mobilephoneno":data[i]['mobilePhone'], 
  //           "lastname":data[i]['surname'], "title":data[i]['title'] };
  //   rows.push(row);
  // }
  var val = { "f":f, "userid":userid, "rows":data };
  // console.log(rows);
  // return false;
