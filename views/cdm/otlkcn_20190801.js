$(function() {
  ...
  $("#btnNewGalInfoItem").on("click", function(){
    ...
    for(var i=0;i<curCnt;i++){
      ...
      html += '<div class="row"><textarea class="form-control" rows="2" cols="" id="txtGalInfoQuestion'+cnt+'" name="txtGalInfoQuestion'+cnt+'" placeholder="Question here">'+ quest +'</textarea></div>';
      html += '<div class="row"><textarea class="form-control" rows="2" cols="" id="txtGalInfoAnswer'+cnt+'" name="txtGalInfoAnswer'+cnt+'" placeholder="Answer here">'+ ans +'</textarea></div>';
      cnt++;
    }

    curCnt++;
    newCnt = curCnt;
    html += '<div class="row"><textarea class="form-control" rows="2" cols="" id="txtGalInfoQuestion'+newCnt+'" name="txtGalInfoQuestion'+newCnt+'" placeholder="Question here"></textarea></div>';
    html += '<div class="row"><textarea class="form-control" rows="2" cols="" id="txtGalInfoAnswer'+newCnt+'" name="txtGalInfoAnswer'+newCnt+'" placeholder="Answer here"></textarea></div>';
...
function saveProst(){
  ...
  var data = { "f": f, "abauser":abauser, "assignedto":assignedto,
