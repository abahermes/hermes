    ...
    getAccessToken(function(accessToken) {
      if (accessToken) {
        ...
        client
          ...
          // .skip(100)
          .top(10)
          // ,surname,jobTitle,businessAddress,businessHomePage,businessPhones,companyName,displayName,emailAddresses,generation,givenName,initials,middleName,mobilePhone,surname,title
          .select('givenName')
          // .select('*')
          .orderby('surname ASC')
          // .get();
