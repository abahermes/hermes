...
<div class="right_col" role="main">
	<div class="page-title">
		<div class="row">
          ...
          <span class="pull-right"><a type="button" class="btn btn-primary" href="#" id="btnImport" data-toggle="modal" data-target="#frmLeadImport" >Import outlook Lead contacts (csv/vcf)</a></span>
...
-->
  ...
  <div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
      <div class="x_panel">
        <fieldset>
          <legend>Showing <b><span id="rowres"></span></b> result(s) of <b><span id="rownum"></span></b> records 
              <span class="pull-right">
                
                <input type="button" id="btnBulkDelete" class="btn btn-warning btn-grad" style="display: none;" value="Bulk Delete" />
                <input type="button" id="btnCanDelete" class="btn btn-warning btn-grad" style="display: none;" value="Cancel" />
                <input type="button" id="btnDelLeads" class="btn btn-warning btn-grad" style="display: none;" value="Delete Selected Lead(s)" />
                <input type="button" id="btnDuplicateLeads" class="btn btn-warning btn-grad" style="display: none;" value="Duplicate Leads (0)" />
                <input type="button" id="btnLeads" class="btn btn-warning btn-grad" style="display: none;" value="Leads List(0)" />
              </span>
          </legend>
          ...
          <div class="table-responsive" id="bulkCtcs" style="display: none;"></div>
          <div class="table-responsive" id="dupLeads" style="display: none;"></div>
        </fieldset>
      </div>
    </div>
  </div>
...
<!-- DUPLICATE LEADS FORM -->
<?php include_once('frmsaveupddellead.php');?>

<!-- SELECT BUSINESS TYPE FORM -->
<?php include_once('frmselectbustype.php');?>
...
<input type="hidden" id="dupleadid" name="dupleadid" value="" />
<input type="hidden" id="acctid_i" name="acctid_i" value="" />
<input type="hidden" id="acctid_c" name="acctid_c" value="" />