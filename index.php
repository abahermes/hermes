<?php 
  ...
  echo '<script type="text/javascript">window.location="dashboardcdm.php";</script>';
?>
  ...
  <body class="nav-md">
    <div class="container body">
      <div class="main_container">
        ...
        <?php include_once('views/dashboard/cdm.php'); ?>
    ...
    <!-- <script src="<?php echo VIEWS . "home/default.js"; ?>"></script> -->
  </body>
</html>